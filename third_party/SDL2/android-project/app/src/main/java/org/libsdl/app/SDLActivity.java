...
*/
    ...
    public static native void onNativeKeyDown(int keycode, int scancode);
    public static native void onNativeKeyUp(int keycode, int scancode);
...
//        }
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            onNativeKeyDown(keyCode, event.getScanCode());
            return true;
        } else if (event.getAction() == KeyEvent.ACTION_UP) {
            onNativeKeyUp(keyCode, event.getScanCode());
            return true;
        }
