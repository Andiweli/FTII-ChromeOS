...
static JNINativeMethod SDLActivity_tab[] = {
    ...
    { "onNativeKeyDown", "(II)V", SDL_JAVA_INTERFACE(onNativeKeyDown) },
    { "onNativeKeyUp", "(II)V", SDL_JAVA_INTERFACE(onNativeKeyUp) },
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(onNativeKeyDown)(
    ...
    jint keycode, jint scancode)
{
    Android_OnKeyDown(keycode, scancode);
}
...
JNIEXPORT void JNICALL SDL_JAVA_INTERFACE(onNativeKeyUp)(
    ...
    jint keycode, jint scancode)
{
    Android_OnKeyUp(keycode, scancode);
}
